...
const about = {
    ...
    intro: {
        display: true,
        title: 'Introduction',
        description: <>Hey There, I'm a Cloud Support Engineer at F13 Technologies, where I ensure smooth and efficient cloud operations. 
        ...
        institutions: [
            {
                ...
                description: <>Earned a Bachelor of Computer Application degree, building a strong foundation in software development, programming, and IT systems. Gained hands-on experience with coding, databases, and problem-solving.</>,
            },
            {
                name: 'Skynet Linux Institute',
                description: <>Completed AWS Solution architect certification and Red Hat Certified System Administrator (RHCSA), gaining expertise in cloud computing, Linux systems, and infrastructure management.</>,
            }
        ]
    },
    technical: {
